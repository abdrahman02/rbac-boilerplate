...
export const navGroupTriggerVariants = tv({
  ...
  variants: {
    activeParent: {
      true:  'bg-primary/[0.18] text-primary',
      false: 'text-sidebar-foreground hover:bg-primary/[0.08] hover:text-foreground',
    },
    collapsed: {
...
export const navGroupChildVariants = tv({
  ...
  variants: {
    active: {
      ...
      false: 'text-sidebar-foreground/70 hover:bg-primary/[0.08] hover:text-foreground',
    },
  },
